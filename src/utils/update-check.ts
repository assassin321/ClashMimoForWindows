export const RELEASES_PAGE_URL = 'https://github.com/assassin321/ClashMimoForWindows/releases';
...
export const UPDATE_AVAILABLE_EVENT = 'clashmeta-update-available';
