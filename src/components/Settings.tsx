            ...
            <Tabs.Content value="general" className="w-full">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  >
                    <option value="Clash Mimo For Windows">Clash Mimo For Windows</option>
              ...
              <div className="flex flex-col items-center text-center py-8">
                ...
                <div className="flex flex-wrap gap-3 w-full max-w-lg justify-center">
                  ...
                  <a
                    ...
                    href="https://github.com/assassin321/Clash Mimo For Windows"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    {t('settings.clashmetaProject')}
                  </a>
                  <Button
