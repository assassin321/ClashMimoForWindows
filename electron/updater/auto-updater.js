...
const RELEASE_API_ENDPOINTS = [
  ...
  'https://mirror.ghproxy.com/https://api.github.com/repos/assassin321/ClashMimoForWindows/releases/latest',
  'https://gh.api.99988866.xyz/https://api.github.com/repos/assassin321/ClashMimoForWindows/releases/latest'
];
    ...
    try {
      ...
      return {
        release: {
          ...
          body: data?.body || '',
          url: data?.html_url || (tagName ? `https://github.com/assassin321/ClashMimoForWindows/releases/tag/${tagName}` : 'https://github.com/assassin321/ClashMimoForWindows/releases'),
          name: data?.name || '',
