  ...
  async function updateTrayMenu() {
    ...
    try {
                      ...
                      try {
                        ...
                        if (switchResponse.ok) {
                          ...
                          if (group.name === 'PROXY' || group.name === 'GLOBAL') {
                            ...
                            state.tray?.setToolTip(`Clash Mimo For Windows - ${nodeName}`);
                          }
      ...
      if (state.currentNode) {
        state.tray.setToolTip(`Clash Mimo For Windows - ${state.currentNode}`);
      } else {
        state.tray.setToolTip('Clash Mimo For Windows');
      }
    } catch (error) {
