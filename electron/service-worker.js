/**
 * Clash Mimo For Windows 核心服务工作进程
 ...
 */
function main() {
  log('INFO', 'Clash Mimo For Windows Core Service Worker starting...');
  ...
  log('INFO', 'Clash Mimo For Windows Core Service Worker started');
}
